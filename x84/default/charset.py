...
# x/84
from bbs import getsession, getterminal, echo, syncterm_setfont, LineEditor
...
prompt_text = (u"Chose an encoding and set font until artwork "
               ...
               u"OSX Clients should chose the Andale Mono font. Linux "
               u"clients should chose the Deja Vu Sans Mono font. ")
