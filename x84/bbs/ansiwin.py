...
GLYPHSETS = {
    ...
    'thin': {
        ...
        'top-right': chr(191).encode('utf-8').decode('cp437'),
        'bot-right': chr(217).encode('utf-8').decode('cp437'),
        'left-vert': chr(179).encode('utf-8').decode('cp437'),
        'right-vert': chr(179).encode('utf-8').decode('cp437'),
        'top-horiz': chr(196).encode('utf-8').decode('cp437'),
        'bot-horiz': chr(196).encode('utf-8').decode('cp437'),
    },
}
