...
def prepare_message(msg, network, parent):
    ...
    from bbs.msgbase import format_origin_line, to_utctime
...
def poll_network_for_messages(net):
    ...
    from bbs import Msg, DBProxy
    from bbs.msgbase import to_localtime
...
def publish_network_messages(net):
    ...
    from bbs.msgbase import format_origin_line, MSGDB
