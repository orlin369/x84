...
class TelnetClient(BaseClient):
    ...
    def __init__(self, sock, address_pair, on_naws=None):
        ...
        self.telnet_sb_buffer = array.array('b')
    ...
    def socket_recv(self):
        ...
        or the connection is closed, bbs.exception.Disconnected is
        raised.
        """
        try:
    ...
    def _recv_byte(self, byte):
        ...
        """
        # print(type(self.recv_buffer))
        # print(self.recv_buffer.__dir__)
        self.recv_buffer.frombytes(str(byte).encode())
